...
class CourseStoreRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge([
            ...
            // Mise en avant réservée aux stages.
            'is_featured' => $isStage
                ? filter_var(
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'end_date' => [
                'required',
                'date',
                'after_or_equal:first_lesson_date',
            ],
            ...
            // Contenu éditorial et bilingue.
            'name_en' => ['nullable', 'string', 'max:255'],
            'sub_type' => [
                $isStage ? 'required' : 'nullable',
                'string',
                Rule::in([
                    'wheel',
                    'external',
            ...
            // Couverture facultative, uniquement pour les stages.
            // Pour un autre type, le champ est exclu des données validées.
            // La taille maximale des fichiers est exprimée en Ko.
            'cover_image' => [
                Rule::excludeIf(! $isStage),
                'bail',
                'nullable',
                'file',
                'image',
    ...
    /**
     * Garde-fou métier : au moins une place au total (Tour ou Modelage).
     */
    ...
    public function messages(): array
    {
        return [
            ...
            // Image de couverture.
            'cover_image.uploaded' => 'Le transfert de l’image a échoué. Vérifiez sa taille et réessayez.',
            'cover_image.file' => 'Veuillez sélectionner un fichier image valide.',
            'cover_image.image' => 'Le fichier sélectionné doit être une image valide.',
            'cover_image.mimes' => 'L’image doit être au format JPG, PNG ou WebP.',
