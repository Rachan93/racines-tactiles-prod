...
const executeDeleteCourse = () => {
    ...
    router.delete(
        route("courses.delete", { course: courseToDelete.value.id }),
        {
            preserveScroll: true,
            onSuccess: () => {
    ...
    <AdminLayout title="Gestion des cours & séances">
        <div class="space-y-6">
            ...
            >
                ...
                <div
                    class="flex items-center gap-1 bg-card border rounded-lg p-1 shadow-2xs text-xs self-start sm:self-auto"
                >
                    <span
                        class="text-[11px] font-medium px-1.5 text-muted-foreground"
                        >Trier par :</span
                    >
            ...
            >
                ...
                <div class="space-y-1">
                    ...
                    <p class="text-xs text-muted-foreground max-w-sm">
                        ...
                        Essayez de réinitialiser les filtres ou créez un nouveau
                        cours.
                    </p>
                </div>
            ...
            <Dialog
                ...
                @update:open="(val) => (isDeleteDialogOpen = val)"
            >
                <DialogContent class="sm:max-w-md">
                        ...
                        <DialogDescription class="text-xs pt-2 space-y-2">
                            <p>
                                ...
                                <strong class="text-foreground"
                                    >« {{ courseToDelete?.name }} »</strong
                                >
                                ? Cette action supprimera également ses
                                <strong class="text-foreground"
                                    >{{
                                        courseToDelete?.stats?.total_lessons
                                    }}
                                    séances</strong
                                >
                                associées.
                    ...
                    <div
                        class="p-3 rounded-lg border border-destructive/30 bg-destructive/5 space-y-2"
                    >
                        <div class="flex items-start gap-2.5">
                            ...
                            >
                                Je confirme la suppression définitive de ce
                                cours et de l'ensemble de son calendrier.
                            </Label>
                        </div>
                    </div>
