...
<head>
    ...
    <title>Session expirée — {{ config('racines.name') }}</title>
...
<body class="bg-white font-brand text-gray-900">
    <main class="min-h-screen px-4 py-12 sm:px-6 lg:px-8">
        ...
        >
            ...
            >
                Cette page est restée inactive trop longtemps ou votre session
                a expiré. Rechargez la page puis réessayez votre action.
            </p>
