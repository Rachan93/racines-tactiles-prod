...
<head>
    ...
    <title>Service indisponible — {{ config('racines.name') }}</title>
...
<body class="bg-white font-brand text-gray-900">
    <main class="min-h-screen px-4 py-12 sm:px-6 lg:px-8">
        ...
        >
            ...
            >
                Le site est momentanément indisponible, probablement en raison
                d’une maintenance ou d’une intervention technique.
